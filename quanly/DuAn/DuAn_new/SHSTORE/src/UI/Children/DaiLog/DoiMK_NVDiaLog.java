 ...
 * @author TIEN SY
 */
public class DoiMK_NVDiaLog extends javax.swing.JDialog {

    /**
     * Creates new form DoiMK_NVDiaLog
     */
    public DoiMK_NVDiaLog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DoiMK_NVDiaLog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DoiMK_NVDiaLog dialog = new DoiMK_NVDiaLog(new javax.swing.JFrame(), true);
